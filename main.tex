...
自从AlexNet~\cite{krizhevsky2012imagenet}通过赢得ImageNet挑战：ILSVRC 2012~\cite{russakovsky2015imagenet}推广深度卷积神经网络以来，卷积神经网络已经在计算机视觉的各个领域中无处不在。总的趋势是制造更深入，更复杂的网络，以实现更高的准确性~\cite{simonyan2014very,Szegedy2016RethinkingTI,szegedy2017inception,He2016DeepRL}。然而，这些提高准确度的进步并不一定使网络在尺寸和速度方面更有效率。在许多应用场景中，例如智能机器人，自动驾驶和增强现实等，需要在计算能力有限的平台上及时地执行识别任务。

在这样的潮流下，人们对更小更高效模型的研究日益增多，例如~\cite{jin2014flattened,wang2017factorized,iandola2016squeezenet,wu2016quantized,rastegari2016xnor}。这些研究大致可以归结为压缩预训练网络或者直接训练小网络。
